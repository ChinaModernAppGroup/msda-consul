...
msdaconsulConfigProcessor.prototype.onPost = function (restOperation) {
    ...
    if (global.msdaconsulOnPolling.includes(inputPoolName)) {
        return logger.fine("MSDA: onPost, already has an instance polling the same pool, please check it out: " + inputPoolName);
    } else { 
        global.msdaconsulOnPolling.push(inputPoolName);
        logger.fine("MSDA onPost: set msdaconsulOnpolling signal: ", global.msdaconsulOnPolling);
    }
