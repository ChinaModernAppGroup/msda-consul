...
function msdaconsulEnforceConfiguredAuditProcessor() {
    ...
    logger.info("loading msdaconsul Enforce Configured Audit Processor");
}
...
msdaconsulEnforceConfiguredAuditProcessor.prototype.WORKER_URI_PATH = "shared/iapp/processors/msdaconsulEnforceConfiguredAudit";

msdaconsulEnforceConfiguredAuditProcessor.prototype.onStart = function (success) {
    logger.fine("msdaconsulEnforceConfiguredAuditProcessor.prototype.onStart");
    //logger.fine("MSDA consul audit onStart: ConfigProcessor polling state: ");
...
msdaconsulEnforceConfiguredAuditProcessor.prototype.onPost = function (restOperation) {
    entryCounter++;
    ...
    //setTimeout(function () {
        try {
            ...
            */
            ...
            logger.fine(
              getLogHeader() + "MSDA consul Audit: msdaconsulOnpolling: ",
              global.msdaconsulOnPolling
            );
            logger.fine(
              getLogHeader() + "MSDA consul Audit: msdaconsul poolName: ",
            ...
            logger.fine(
                getLogHeader() +
                    "msdaconsulEnforceConfiguredAuditProcessor.prototype.onPost caught generic exception " +
                    ex
            );
...
msdaconsulEnforceConfiguredAuditProcessor.prototype.finishOperation = function( restOperation, auditTaskState ) {
    restOperation.setBody(auditTaskState);
    this.completeRestOperation(restOperation);
    logger.fine(getLogHeader() + "DONE" );
};

module.exports = msdaconsulEnforceConfiguredAuditProcessor;
